...
import CircleRating from "../../../components/circle_rating/CircleRating";
import Img from "../../../components/lazy_load_img/Img.jsx";
import PosterFallback from "../../../assets/no-poster.png";
import { PlayIcon } from "../PlayBtn.jsx";
import VideoPopup from "../../../components/video_popup/VideoPopup.jsx";
                    ...
                    <React.Fragment>
                        ...
                        <ContentWrapper>
                            <div className="content">
                                ...
                                <div className="right">
                                    <div className="title">
                                        {`${data.name || data.title} (${dayjs(data.relesae_date).format("YYYY")})`}
                                    </div>
